            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="roleId" id="roleId" class="form-control" required>
                        ...
                        <option value="{{ $role->id }}" {{ $role->id == $data->roleId ? 'selected' : '' }}>{{ $role->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="departmentId" id="departmentId" class="form-control" required>
                        ...
                        <option value="{{ $department->id }}" {{ $department->id == $data->departmentId ? 'selected' : '' }}>{{ $department->name }}
                        </option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="areaId" id="areaId" class="form-control" required>
                        ...
                        <option value="{{ $area->id }}" {{ $area->id == $data->areaId ? 'selected' : '' }}>{{ $area->name }}
                        </option>
                        @endforeach
                    </select>
                </div>
